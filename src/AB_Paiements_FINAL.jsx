...
function FormulaireFacture({ facture, onSauvegarder, onAnnuler }) {
    ...
    <div style={{ background: 'rgba(201,162,39,.10)', border: '1px solid rgba(201,162,39,.4)', borderRadius: '10px', padding: '14px 15px', marginBottom: '16px' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '9px' }}>
        <div>
          ...
          <input type="text" name="fournisseur" value={formData.fournisseur} onChange={handleChange} required placeholder="Nom" style={{ background: '#fff', border: '1px solid rgba(22,45,73,.25)', borderRadius: '7px', padding: '9px 11px', fontSize: '13.5px', width: '100%' }} />
        </div>
